...
public class GameActivity extends AppCompatActivity implements ItemDragListAdapter.CallbackInterface {
...
StartGameButton=(Button)findViewById(R.id.startingTheGameBut);


     //Getting the information from the intent
        FragmentManager fm = getSupportFragmentManager();
        final my_dragalble_fragment my_dragalble_fragment1 =(my_dragalble_fragment) getSupportFragmentManager().findFragmentById(R.id.mydragfrag);
...
//                //Not Working :O
//                if(my_dragalble_fragment1.ChackIfGameSet()==true){
//                    ArrayList<Player> myTeam=my_dragalble_fragment1.CallingPlayerList();
//                    //Testing if reciving the player list;
//                    Player player=myTeam.get(0);
...
//        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.v("i am here not there","Dam Right");
